...
public class Meow {
  ...
  ApplicationContext context = new ClassPathXmlApplicationContext("C:\Program Files (x86)\Jenkins\workspace\NBC DSL APPROACH\src\main\resources\ApplicationContext.xml");
  void main() {
